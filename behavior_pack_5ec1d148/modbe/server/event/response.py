...
def onAddEntityServerEvent(args):
    ...
    Callback.invoke(Callback.getCallbackNameByEngineEvent("AddEntityServerEvent"), entity, args["engineTypeStr"], pos, args["dimensionId"], args["isBaby"],
...
def onServerItemTryUseEvent(args):
    ...
    # Callback.invoke(Callback.getCallbackNameByEngineEvent("ServerItemTryUseEvent"), entity, args["itemName"], args["auxValue"], itemStack)
...
def onServerItemUseEvent(args):
    entity = Actor(args["playerId"])
    Callback.invoke(Callback.getCallbackNameByEngineEvent("ServerItemUseEvent"), entity, args["itemName"], args["auxValue"])
